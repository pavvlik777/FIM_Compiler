...
{
    public class SubstractionPrefix : TokenRule
    {
        public SubstractionPrefix()
        {
        ...
        public override bool IsStackMatch(List<Token> stack)
        {
            ...
            {
                if (KeywordsDictionary.IsKeyword(KeywordType.ArifmeticSubstractionPrefixFirst, stack[stack.Count - 7].Value)
                    && KeywordsDictionary.IsKeyword(KeywordType.ArifmeticSubstractionPrefixSecond, stack[stack.Count - 3].Value))
                {
