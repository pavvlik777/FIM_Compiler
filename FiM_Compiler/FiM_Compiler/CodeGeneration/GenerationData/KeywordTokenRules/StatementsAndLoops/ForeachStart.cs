...
namespace FiM_Compiler.CodeGeneration.GenerationData.KeywordTokenRules.StatementsAndLoops
{
    ...
    {
        public ForeachStart() //TODO mb add feature to declare variable in for/foreach start 
            //TODO можно заменить тип + переменная на объявление переменной в виде синтаксического сахара
        {
