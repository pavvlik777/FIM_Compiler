...
namespace FiM_Compiler.CodeGeneration.Compilers.CSharp.ErrorsChecks
{
    public class NamesErrorChecks : ILexerErrorCheck
    {
        ...
        (bool, LevelType) Check(List<Token> tokens, LevelType parent, List<Error> compileErrors, ref int currentIndex, ref int endIndex, List<string> classes, List<string> interfaces, List<string> methods, List<string> variables)
        {
